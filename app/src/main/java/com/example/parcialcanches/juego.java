...
public class juego extends AppCompatActivity implements View.OnClickListener {
    ...
    public void Reiniciar(View view) {
        ...
        if (!playerone) {
            valorx = "O";
            Toast.makeText(this, "COMIENZA -oOo-", Toast.LENGTH_SHORT).show();
        } else {
            valorx = "X";
            Toast.makeText(this, "COMIENZA -xXx-", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void verificarGanador(String valorX) {
        ...
        if (ganador) {
            if (valorX.equals("X")) {
                Toast.makeText(this, "GANASTE!!! \uD83D\uDC4C -xXx-", Toast.LENGTH_SHORT).show();
                x++;
                tvX.setText("X: " + x);
            } else {
                Toast.makeText(this, "GANASTE!!! \uD83D\uDC4C -oOo-", Toast.LENGTH_SHORT).show();
                o++;
                tvO.setText("O: " + o);
            }
